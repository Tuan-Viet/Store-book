...
const signup = () => {
    ...
    const toggleConfrimPasswordVisibility = () => {
        setShowConfirmPassword(!showConfirmmPassword);
    };
    return <>
                ...
                >
                    ...
                    <div >
                        ...
                        <div className="relative mt-7">
                            ...
                            />
                            <span className="absolute inset-y-0 end-0 grid place-content-center px-4 cursor-pointer" onClick={toggleConfrimPasswordVisibility}>
                                {showConfirmmPassword ? (
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke-width="1.5"
